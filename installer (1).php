...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230303_glassart_7312a0afb77e87409643_20230303164832_archive.zip';
        const ARCHIVE_SIZE       = '448463';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '7312a0a-03164832';
        const SECONDARY_PACKAGE_HASH = '2abbac7-03164832';
